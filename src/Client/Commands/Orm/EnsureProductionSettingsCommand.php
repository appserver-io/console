...
/**
 * AppserverIo\Console\Client\Commands\Orm\EnsureProductionSettingsCommand
 *
 * NOTICE OF LICENSE
 *
...
/**
 * The command implementation to verify that Doctrine is properly configured for a production environment.
 *
 * @author    Tim Wagner <tw@appserver.io>
 * @copyright 2018 TechDivision GmbH <info@appserver.io>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
