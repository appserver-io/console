...
/**
 * AppserverIo\Console\Client\Commands\Orm\RunDqlCommand
 *
 * NOTICE OF LICENSE
 *
...
/**
 * The command implementation to execute arbitrary DQL directly from the command line.
 *
 * @author    Tim Wagner <tw@appserver.io>
 * @copyright 2018 TechDivision GmbH <info@appserver.io>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 ...
 * @link      http://www.appserver.io
 */
class RunDqlCommand extends \Doctrine\ORM\Tools\Console\Command\RunDqlCommand
{
