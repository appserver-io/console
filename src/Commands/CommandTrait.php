...
/**
 * AppserverIo\Console\Commands\CommandTrait
 *
 * NOTICE OF LICENSE
 *
...
namespace AppserverIo\Console\Commands;

use Psr\Log\LoggerInterface;
use AppserverIo\Console\Utils\InputOptionKeys;
...
trait CommandTrait
{
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $command = sprintf('%s %s %s', $this->getCommandName(), $this->getApplicationName($input), $this->getName());
