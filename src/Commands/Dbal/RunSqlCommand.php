...
/**
 * AppserverIo\Console\Commands\Dbal\RunSqlCommand
 *
 * NOTICE OF LICENSE
 *
...
namespace AppserverIo\Console\Commands\Dbal;

use AppserverIo\Console\Commands\CommandTrait;

/**
 * The command implementation to execute arbitrary SQL directly from the command line.
 *
 * @author    Tim Wagner <tw@appserver.io>
 * @copyright 2018 TechDivision GmbH <info@appserver.io>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
